...
'[Fonts & colors] -----------------------------------------------------------------------------------------
Public Const MIELK_COLOR As Long = 6066688
Public Const MIELK_COLOR_LIGHT As Long = 8103473
Public Const APP_FONT_FAMILY As String = "Segoe UI"
...
Public Const CREATE_IMAGE_TAG As String = "Forms.Image.1"
